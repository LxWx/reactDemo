					...
					<div className="index-mid-box" style={{ height: '100%', }}>
						<form className="J-search-form">
							<div className="float-mid" style={{ top: '50%', marginLeft: '-245px', marginTop: '-145px', }}>
								...
								<div className="search-box" style={{ width: '490px', height: '60px', position: 'relative', border: '0px', background: 'none', margin: '0 auto', }}><span onClick={this.hide} id="012501601168374732_span" className="search-topic" style={{ left: '15px', display: this.state.spanHide }}>请输入职位关键词</span>
									<div style={{ width: '100%', height: '100%', background: '#fff', position: 'absolute', opacity: '0.1', filter: 'alpha(opacity=10)', }}></div>
									<input ref={this.myInput} value={this.state.inputValue} onChange={this.change} type="text" topic="请输入职位关键词" style={{ width: '368px', height: '40px', paddingTop: '6px', marginTop: '6px', marginLeft: '10px', boxSizing: 'border-box', borderRadius: '3px', }} className="search-text" id="012501601168374732" />
